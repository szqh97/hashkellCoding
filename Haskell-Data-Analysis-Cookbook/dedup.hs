...
main :: IO ()
main = do
    let fileName = "/Users/li_yun/Projects/Haskell-Data-Analysis-Cookbook/Ch02/Code07_dedup/input.csv"
...
parseItem record = 
    Artist { name  = nameStr,
             song = if null songStr then S.empty else S.singleton songStr,
