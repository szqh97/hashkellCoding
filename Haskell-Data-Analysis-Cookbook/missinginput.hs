...
main :: IO ()
main = do
    let fileName = "/Users/li_yun/Projects/Haskell-Data-Analysis-Cookbook/Ch02/Code03_unexpected/input.csv"
...
parseLaptops (Right csv) = foldl (\a record -> if length record == 3 then (parseLaptop record): a else a) [] csv
